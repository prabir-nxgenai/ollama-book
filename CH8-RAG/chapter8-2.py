...
import whisper, requests, os, numpy as np, tempfile, wave
import faiss
from sentence_transformers import SentenceTransformer
import torch

# Using the same LLM for embedding as well
embedding_model = SentenceTransformer('llama3.1')
...
def text_to_speech(text):
    os.system(f'echo "{text}" | /home/prabir/piper/build/piper --model /usr/local/share/piper/models/en_US-lessac-medium.onnx --output_file response.wav && aplay response.wav')
